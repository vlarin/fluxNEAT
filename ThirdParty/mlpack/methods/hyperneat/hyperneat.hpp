 ...
 */
#ifndef MLPACK_METHODS_HNEAT_NEAT_HPP
#define MLPACK_METHODS_HNEAT_NEAT_HPP
...
/**
 * The main class for Hyper NeuroEvolution of Augmenting Topologies.
 *
