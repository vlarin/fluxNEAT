...
#ifndef MLPACK_METHODS_HNEAT_NEAT_IMPL_HPP
#define MLPACK_METHODS_HNEAT_NEAT_IMPL_HPP
...
HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::
HyperNEAT(TaskType& task,
...
template<class TaskType,
         class ActivationFunction,
         class SelectionPolicy>
void HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::ForceInit()
{
...
template <class TaskType,
          class ActivationFunction,
          class SelectionPolicy>
void HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::Speciate(bool init)
{
...
template <class TaskType,
          class ActivationFunction,
          class SelectionPolicy>
void HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::Reproduce()
{
...
template <class TaskType,
          class ActivationFunction,
          class SelectionPolicy>
Genome<ActivationFunction> HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>
...
template <class TaskType,
          class ActivationFunction,
          class SelectionPolicy>
bool HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::
...
typename std::enable_if<
    ...
    void>::type
HyperNEAT<TaskType, ActivationFunction, SelectionPolicy>::Initialize()
{
