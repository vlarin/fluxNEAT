...
#ifndef MLPACK_METHODS_HNEAT_ACYCLIC_NET_HPP
#define MLPACK_METHODS_HNEAT_ACYCLIC_NET_HPP
 ...
 * 
 * @tparam ActivationFunction The hyper neat activation function (multimodal).
 */
