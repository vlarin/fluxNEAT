 ...
 */
#ifndef MLPACK_METHODS_HNEAT_GENE_IMPL_HPP
#define MLPACK_METHODS_HNEAT_GENE_IMPL_HPP
...
void ConnectionGene::MutateSourceActivation()
{
    sourceActivation = (size_t)(MultimodalActivationFunction::Size() * arma::randu());
}
                              ...
                              const unsigned int /* version */)
{
  ...
  ar & BOOST_SERIALIZATION_NVP(sourceActivation);
