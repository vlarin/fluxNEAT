 ...
 */
#ifndef MLPACK_METHODS_HNEAT_GENOME_HPP
#define MLPACK_METHODS_HNEAT_GENOME_HPP
...
class Genome
{
 public:
   ...
   * 
   * @param inputNodeCount The number of CPPN input nodes.
   * @param outputNodeCount The number of CPPN output nodes.
   ...
   */
  Genome(std::vector<size_t> substrateLayers,
         const size_t cppnInputNodeCount,  //TODO: rename to CPPN dimensions
         const size_t cppnOutputNodeCount, //TODO: remove
         const double bias,
  ...
  Genome(std::vector<ConnectionGene>& connectionGeneList,
         ...
         const size_t cppnOutputNodeCount,
  ...
  /**
   * A vector containing substrate configuration (input count, hidden layers sizes, output layer size)
   */
  std::vector<size_t> substrateLayers;
 ...
 private:
  ...
  //! Hyper NEAT substrate
  Substrate<ActivationFunction> substrate;
};
