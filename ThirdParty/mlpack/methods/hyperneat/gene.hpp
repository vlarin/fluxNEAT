...
class ConnectionGene
{
 public:
   ...
   * @param activationType Neuron activation function type (symmetry, variation, periodic)
  ...
  /**
   * Mutate the type of activation neuron
   */
  inline void MutateSourceActivation();
  ...
  size_t SourceActivation() const { return sourceActivation; }

  size_t& SourceActivation() { return sourceActivation; }
